#ifndef TRAJ_REPLAYER_RT
#define TRAJ_REPLAYER_RT
...
#include <repair_cntrl/ReplayNow.h>
 ...
 */
class TrajReplayerRt : public ControlPlugin
{
...
private:
   ...
   // handle adapting ROS primitives for RT support
    ...
    bool on_replay_msg_rcvd(const repair_cntrl::ReplayNowRequest& req,
                          repair_cntrl::ReplayNowResponse& res);

    ServiceServerPtr<repair_cntrl::ReplayNowRequest,
                     repair_cntrl::ReplayNowResponse> _replay_now_srv;
                 
};

#endif // TRAJ_REPLAYER_RT